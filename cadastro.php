...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO clientes(nome, telefone, cpf, rg, data_nascimento, username, email, endereco, cidade, estado, senha) 
            VALUES ('$nome', '$telefone', '$cpf', '$rg', '$data_nascimento', '$username', '$email', '$endereco', '$cidade', '$estado', '$senha')";
